...
local M = {}
M.order = {"enabled", "freeCamera", "targeting", "crosshair", "delayMs", "coneDegrees", "aimAssist", "assistStrength", "debugLogging", "cameraMode", "trackingSpeed", "trackingResumeMs", "lockLastAttacker"}
M.rules = {
